...
/**
 * shell_num_builtins - count the amount of builtins available
...
int shell_help(char *args[])
{
	...
	*args = *args;
	_puts("Joy and Kenny\n");
	_puts("Type program names and arguments, and it enter.\n");
 ...
 * @args: array of strings with the arguments
 * @Return: returns 1 if success or exit if fail
 */
 ...
 * @args: array of strings with the arguments
 * Return: return 1 is success or exit if fail
 */
